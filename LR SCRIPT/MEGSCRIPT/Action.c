Action()
{
	...
	lr_start_transaction("T01_SIGN IN");
	...
	lr_end_transaction("T01_SIGN IN",LR_AUTO);

	lr_start_transaction("T02_Navigate Flight");
	...
	lr_end_transaction("T02_Navigate Flight",LR_AUTO);

	lr_start_transaction("T03_Flind Flight");
	...
	lr_end_transaction("T03_Flind Flight",LR_AUTO);

	lr_start_transaction("T04_Flind Flight");
	...
	lr_end_transaction("T04_Flind Flight",LR_AUTO);

	lr_start_transaction("T05_Payment ");
	...
	lr_end_transaction("T05_Payment ",LR_AUTO);

	lr_start_transaction("T06_Sign Off");
	...
	lr_end_transaction("T06_Sign Off",LR_AUTO);
