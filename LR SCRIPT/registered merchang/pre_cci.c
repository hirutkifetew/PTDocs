# 1 "c:\\users\\kokob\\desktop\\lr script\\registered merchang\\\\combined_registered merchang.c"
...
# 1 "c:\\users\\kokob\\desktop\\lr script\\registered merchang\\\\combined_registered merchang.c" 2
...
# 2 "c:\\users\\kokob\\desktop\\lr script\\registered merchang\\\\combined_registered merchang.c" 2
...
# 3 "c:\\users\\kokob\\desktop\\lr script\\registered merchang\\\\combined_registered merchang.c" 2
...
# 4 "c:\\users\\kokob\\desktop\\lr script\\registered merchang\\\\combined_registered merchang.c" 2
...
Action()
{
	...
	lr_end_transaction("sequrity question",2);
	...
	lr_end_transaction("NavigateMerchantTab",2);
	...
	lr_end_transaction("Savemerchant",2);
	...
	lr_end_transaction("Click Process",2);
	...
	lr_end_transaction("click_process",2);

	lr_think_time(46);

	lr_start_transaction("clickprocess");

	lr_end_transaction("clickprocess",2);
	...
	lr_end_transaction("Searchmerchants",2);
...
# 5 "c:\\users\\kokob\\desktop\\lr script\\registered merchang\\\\combined_registered merchang.c" 2
...
# 6 "c:\\users\\kokob\\desktop\\lr script\\registered merchang\\\\combined_registered merchang.c" 2
