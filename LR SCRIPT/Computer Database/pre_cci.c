# 1 "c:\\users\\kokob\\desktop\\lr script\\computer database\\\\combined_Computer Database.c"
...
# 1 "c:\\users\\kokob\\desktop\\lr script\\computer database\\\\combined_Computer Database.c" 2
...
# 2 "c:\\users\\kokob\\desktop\\lr script\\computer database\\\\combined_Computer Database.c" 2
...
# 3 "c:\\users\\kokob\\desktop\\lr script\\computer database\\\\combined_Computer Database.c" 2
...
# 4 "c:\\users\\kokob\\desktop\\lr script\\computer database\\\\combined_Computer Database.c" 2
...
Action()
{
 ...
 
 {
	...
	lr_end_transaction(strTransactionName,2);
 }
	...
	lr_end_transaction("Pagination 3",2);
	...
	lr_end_transaction("Search_ computer",2);
	...
	lr_end_transaction("Click_Computer",2);
	...
	lr_end_transaction("Save_C0mputer",2);

	return 0;
} 
# 5 "c:\\users\\kokob\\desktop\\lr script\\computer database\\\\combined_Computer Database.c" 2
...
# 6 "c:\\users\\kokob\\desktop\\lr script\\computer database\\\\combined_Computer Database.c" 2
