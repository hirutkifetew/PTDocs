# 1 "c:\\users\\kokob\\desktop\\lr script\\samuti\\\\combined_samuti.c"
...
# 1 "c:\\users\\kokob\\desktop\\lr script\\samuti\\\\combined_samuti.c" 2
...
# 2 "c:\\users\\kokob\\desktop\\lr script\\samuti\\\\combined_samuti.c" 2
...
# 3 "c:\\users\\kokob\\desktop\\lr script\\samuti\\\\combined_samuti.c" 2
...
# 4 "c:\\users\\kokob\\desktop\\lr script\\samuti\\\\combined_samuti.c" 2
...
web_reg_save_param_ex("ParamName=userSession","LB=value=\"","RB=\"/>","LAST");
	...
	(web_remove_auto_header("Sec-Mesh-Client-Arch", "ImplicitGen=Yes", "LAST"));

	(web_remove_auto_header("Sec-Mesh-Client-Edge-Channel", "ImplicitGen=Yes", "LAST"));

	(web_remove_auto_header("Sec-Mesh-Client-Edge-Version", "ImplicitGen=Yes", "LAST"));

	(web_remove_auto_header("Sec-Mesh-Client-OS", "ImplicitGen=Yes", "LAST"));

	(web_remove_auto_header("Sec-Mesh-Client-OS-Version", "ImplicitGen=Yes", "LAST"));

	(web_remove_auto_header("Sec-Mesh-Client-WebView", "ImplicitGen=Yes", "LAST"));

	(web_remove_auto_header("X-Microsoft-Update-Service-Cohort", "ImplicitGen=Yes", "LAST"));
...
# 5 "c:\\users\\kokob\\desktop\\lr script\\samuti\\\\combined_samuti.c" 2
...
# 6 "c:\\users\\kokob\\desktop\\lr script\\samuti\\\\combined_samuti.c" 2
